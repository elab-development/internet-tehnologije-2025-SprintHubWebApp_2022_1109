...
async function main() {
  ...
  console.log('  MODERATOR: jelena@sprinthub.test / Moderator1');
  console.log('  USER:      marko@sprinthub.test / Password1');
  console.log('  USER:      ana@sprinthub.test / Password1');
  console.log('  USER:      stefan@sprinthub.test / Password1');
  console.log('═══════════════════════════════════════════════════════\n');
}
